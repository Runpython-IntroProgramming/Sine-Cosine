...
sprites=[Sprite(blucir,(x, x*1)) for x in brxcor,(x, x*1) for y in bycor]
sprites=[Sprite(redcir,(x, x*1)) for x in brxcor,(x, x*1) for y in rycor]
sprites=[Sprite(purcir,(x, x*1)) for x in pxcor,(x, x*1) for y in pycor]
myapp=App()
myapp.run()